let products = [
    { id: 1, name: "Bat", price: 6, is_featured: false },
    { id: 2, name: "Cricket Pads",price: 20, is_featured: false },
    { id: 3, name: "Football", price: 20, is_featured: false },
]
//taking index
...
for (i = 0; i < cartArray.length; i++) {
    ...
    cartWrapper.className = 'cart-title-wrapper'
    ...
    // appending heading to cartbody as child
